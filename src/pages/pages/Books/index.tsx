            ...
            <section className="flex items-center flex-col gap-10 py-4">
                ...
                {bookOne >= 100 && books.c <= 100 ?
                    <div className="flex w-[95%]  items-center justify-between pb-8 border-0 border-b border-white">
                        ...
                        <Button event={() => buyUpgrade2('c', books, (10000 * books.c)**1.02, setBooks, knowledge, setKnowledge)}>
                            <p>For next level: {formatNumber((10000 * books.c) ** 1.02)} knowledge</p> 
                        </Button>
                    </div>
                :null}
            </section>
